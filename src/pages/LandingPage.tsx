      ...
      <nav className="fixed w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5 text-indigo-600">
            ...
            <span className="text-xl font-bold text-gray-900 tracking-tight">DualSpend</span>
          </div>
          <div className="flex items-center gap-6">
            <Link to="/dashboard" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">Log in</Link>
            <Link to="/dashboard">
        ...
        <div className="relative overflow-hidden pt-20 pb-24 lg:pt-32 lg:pb-40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 tracking-tight mb-8 leading-[1.1]">
              Spend management <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">for modern teams</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
              <Link to="/dashboard">
                <Button size="lg" className="h-14 px-8 text-lg rounded-full shadow-xl shadow-indigo-600/20 w-full sm:w-auto">
            ...
            <div className="relative mx-auto max-w-6xl">
              ...
              <div className="relative bg-gray-900 rounded-xl shadow-2xl border border-gray-800 overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-800 bg-gray-900/50">
                  ...
                  <div className="mx-auto px-3 py-1 bg-gray-800 rounded-md text-xs text-gray-400 font-mono">dualspend.com/dashboard</div>
                </div>
                <img 
        ...
        <div className="py-24 bg-gray-50 border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Everything you need to scale</h2>
              <p className="mt-4 text-gray-500">Powerful features built for the next generation of companies.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Instant Approvals</h3>
                <p className="text-gray-500 leading-relaxed">Automate expense policies and approve requests in seconds via Slack or email. No more chasing receipts.</p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mb-6">
                ...
                <p className="text-gray-500 leading-relaxed">Bank-grade encryption, SOC 2 compliance, and advanced fraud detection to keep your data safe.</p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mb-6">
                ...
                <p className="text-gray-500 leading-relaxed">Syncs seamlessly with QuickBooks, Xero, NetSuite, and other accounting tools in real-time.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-white border-t border-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2 text-gray-900">
            <Hexagon className="w-5 h-5 fill-current text-indigo-600" />
            <span className="font-bold tracking-tight">DualSpend</span>
          </div>
          <p className="text-gray-500 text-sm">© 2024 DualSpend Inc. All rights reserved.</p>
