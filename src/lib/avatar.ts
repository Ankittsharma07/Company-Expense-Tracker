const md5 = (input: string) => {
  const toUtf8 = (str: string) => unescape(encodeURIComponent(str));
  ...
  const x = convertToWordArray(toUtf8(input));
  let a = 0x67452301;
  let b = 0xefcdab89;
  let c = 0x98badcfe;
  let d = 0x10325476;
...
export const getGravatarUrl = (email: string, size = 128, style = "identicon") => {
